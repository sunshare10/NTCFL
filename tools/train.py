...
def main():
    ...
    train_loader = DataLoader(train_dataset,  shuffle=True, batch_size=32, num_workers=data_cfg.get('num_workers'), pin_memory=False,
    drop_last=True)
    val_loader = DataLoader(test_dataset,  shuffle=True, batch_size=32, num_workers=data_cfg.get('num_workers'), pin_memory=False,
    drop_last=True)
