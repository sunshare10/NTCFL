...
def parse_args():
    ...
    parser.add_argument('img', help='Image file',default='E:/1/last/version819/split/h5_4_1500ipniming_daifangxiang/BaiduNetdisk/21.png')
    parser.add_argument('config', help='Config file',default='models/swin_transformer/base_160.py')
    parser.add_argument(
        '--target-layers',
        default=[],
        nargs='+',
